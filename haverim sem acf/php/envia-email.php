<?php
	class Email {
		...
		public static function enviar( $body, $nome, $email, $formulario){
			$retorno = 0;
			...
			// Define o remetente
			$mail->From = "geovaniaspe@gmail.com";
			$mail->FromName = "Geovani Assis"; 

			// Define o retorno de resposta
			$mail->AddReplyTo("geovaniaspe@gmail.com", "Geovani | Programador");
			...
			$mail->Subject = $tipo .' | '.$formulario; // Assunto da mensagem
			...
			if ($enviado) {
				...
				$retorno = "Não foi possivel enviar o e-mail.";
			}
