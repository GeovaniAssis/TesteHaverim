			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
				<div class="row">
					<div class="col-lg-12 titulo">
						<h2 class="font--open-sans" style="margin-top: 50px;"><?php the_field('titulovisita'); ?></h2>
						<p class="font--open-sans" style="margin-top: 30px; margin-bottom: 30px;"><?php the_field('textovisita'); ?></p>
