    ...
    <section class="titulo-top">
        <div class="container">
            <div class="row bord--left">
                <img src="<?php echo bloginfo('template_url'); ?>/img/icon/icon-noticias-titulo.png" style="margin-top: 5px;">
                <h2>Notícias</h2>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                                    ...
                                    <div class="img">
                                        <?php if ( has_post_thumbnail( $post->ID ) ): ?>
                                            ...
                                            <?php 
                                             ...
                                             ?>
                                            <img class="img-thumb lazyload imagem-destaque" data-src="<?php echo $image[0]; ?>" class="" <?php if( $d >= 1 ) { ?> style="filter: brightness(0.5);" <?php } ?> >
                ...
                <div id="barra-lateral" class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
                    ...
                    <div id="categorias">
                        ...
                        <img class="img-banner lazyload" data-src="<?php echo bloginfo('template_url'); ?>/img/residencial/praia-recreio/mini-banner.jpg"> 
