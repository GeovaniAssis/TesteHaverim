...
var nicEditorConfig = bkClass.extend({
  buttons: {
    ...
    'ol': {
      name: __('Inserir lista ordenada'),
      command: 'insertorderedlist',
      tags: ['OL']
    },
    'ul': {
      name: __('Inserir lista não ordenada'),
    ...
    'indent': {
      name: __('Aumentar recuo'),
      command: 'indent',
      noActive: true
    },
    'outdent': {
      name: __('Diminuir recuo'),
      command: 'outdent',
      noActive: true
    },
    'hr': {
      name: __('Linha horizontal'),
...
var nicColorOptions = {
  buttons: {
    'forecolor': {
      name: __('Alterar cor do texto'),
      type: 'nicEditorColorButton',
      noClose: true
    },
    'bgcolor': {
      name: __('Alterar cor do fundo'),
